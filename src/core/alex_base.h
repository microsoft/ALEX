...
/* This file contains the classes for linear models and model builders, helpers for the bitmap,
 * cost model weights, statistic accumulators for collecting cost model statistics,
...
// Accumulates stats that are used in the cost model, based on the actual vs predicted position of a key
